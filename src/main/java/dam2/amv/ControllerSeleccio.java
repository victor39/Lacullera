...
public class ControllerSeleccio implements Initializable {
	...
	// Contenidor de javaFX controla si afegim o eliminem un element al contenidor,
	// de tal manera que queda reflexat en la vista.
	private ObservableList<Carta> listaCarta;

	// mètode per inicialitzar els components, per exemple si no inicialitzem els
	// components combobox pot generar una excepció per que es troba a null.
	// Aquest métode l'hem dimplementar ja que la classe implementa inicializable.

	public void initialize(URL location, ResourceBundle resources) {

		// Inicialitzem l'obserbableList amb un métode de la classe FXCollections que
		// ens retorna un Observable Arraylist.
		listaCarta = FXCollections.observableArrayList();

		// Inicialitzem la conneci� a la base de dades

		// El ObservableList ha de coincidir en el tipus d'objecte amb la llista que li
		// passem.
		/********************************************************************************************
		 * Filtrat
		 */
		...
		// Cridem al m�tode que ens retorna els elements de la taula Carrera Com els
		// par�metres es passen per refer�ncia el que estem fent �s actualitzar la
		// llista que passem per par�metre
